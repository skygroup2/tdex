defmodule Tdex.WS.Rows do
  ...
  def read_row(pid, dataQuery, timeout, precision, data \\ []) do
    ...
    do
      result = Binary.parse_block(dataBlock, dataQuery["fields_names"], precision, data)
      read_row(pid, dataQuery, timeout, precision, result)
    else
      {:ok, _} ->
